...
:- determination(has_gills/1,animal/1).
:- determination(has_gills/1,class/1).
:- determination(has_gills/1,class/2).
:- determination(has_gills/1,has_milk/1).
:- determination(has_gills/1,lay_eggs/1).
:- determination(has_gills/1,homeothermic/1).
:- determination(has_gills/1,lives_in_water/1).
:- determination(has_gills/1,fly/1).
