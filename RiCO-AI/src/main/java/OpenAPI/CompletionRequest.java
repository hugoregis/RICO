...
public class CompletionRequest {
    public static void runPL2English(String listPred){
        ...
        final ChatMessage systemMessage = new ChatMessage(ChatMessageRole.SYSTEM.value(),
                "Predicate logic expresses natural language propositions into the following format: predicate(arguments), where 'arguments' can be composed of one or multiple objects. \n" +
                        ...
                        "\n" +
                        "Now, assuming a certain predicate logic framework, how would you convert the following list of predicate logic expressions into a list of natural language expressions? And for each expression, specify in parenthesis if it would be commonly considered as a true proposition or not.\n" +
                        listPred
                );
