...
:- determination(class/2,animal/1).
:- determination(class/2,class/1).
:- determination(class/2,has_milk/1).
:- determination(class/2,lay_eggs/1).
:- determination(class/2,homeothermic/1).
:- determination(class/2,has_gills/1).
:- determination(class/2,lives_in_water/1).
:- determination(class/2,fly/1).
