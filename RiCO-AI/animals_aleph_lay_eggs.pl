...
:- determination(lay_eggs/1,animal/1).
:- determination(lay_eggs/1,class/1).
:- determination(lay_eggs/1,class/2).
:- determination(lay_eggs/1,has_milk/1).
:- determination(lay_eggs/1,homeothermic/1).
:- determination(lay_eggs/1,has_gills/1).
:- determination(lay_eggs/1,lives_in_water/1).
:- determination(lay_eggs/1,fly/1).
